...
RSpec.describe Post, type: :model do
    ...
    subject{first_post = Post.new(author: user1, title: 'Hello', text: 'This is my first post')}
    ...
    describe '#recent_comments' do
        it 'should return 5 recent comments' do
            ...
            user3 = User.create(name: 'Lala', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Teacher from Kenya.')
            user4 = User.create(name: 'Lolo', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Teacher from Nigeria.')
            user5 = User.create(name: 'Lele', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Teacher from Ethiopia.')
            user6 = User.create(name: 'Lulu', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Teacher from Uganda.')
